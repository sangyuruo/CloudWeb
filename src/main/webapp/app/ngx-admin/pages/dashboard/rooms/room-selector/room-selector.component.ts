  ...
  roomSvg = {
    ...
    rooms: [
      ...
      },
      {
        ...
        area: { d: 'M358.8,160V49.82a6.09,6.09,0,0,example.component.ts,6.09-6.09H570.78a6.09,6.09,0,0,example.component.ts,6.09,6.09V218.9a6.09' +
          ',6.09,0,0,example.component.ts-6.09,6.09h-212Z' },
        border: { d: 'M358.8,160V49.82a6.09,6.09,0,0,example.component.ts,6.09-6.09H570.78a6.09,6.09,0,0,example.component.ts,6.09,6.09V218.9a6.09' +
          ',6.09,0,0,example.component.ts-6.09,6.09h-212' },
      },
      {
        id: '3',
        ...
        border: { d: 'M216.37,225V356 M216.21,162V92.5H358.8V160 M358.8,225H424.39V312.91a6.09,' +
          '6.09,0,0,example.component.ts,-6.09,6.09H272.71V356' },
      },
    ],
  };
